        ...
        'items'=>array(
            array(
                ...
                'items'=>array(
                    ...
                    array('label'=>'Tin nhắn mẫu', 'url'=>array('/templatesms/admin'),'visible'=>!Yii::app()->user->isGuest),
                    array('label'=>'Danh bạ', 'url'=>array('/contactCategorie/admin'),'visible'=>!Yii::app()->user->isGuest),
                    array('label'=>'Nhật ký gửi SMS', 'url'=>array('/history/admin'),'visible'=>!Yii::app()->user->isGuest),
                    array('label'=>'Tìm kiếm', 'url'=>'#','visible'=>!Yii::app()->user->isGuest),
                    array('label'=>'Báo cáo', 'url'=>'#','visible'=>!Yii::app()->user->isGuest),
                    array('label'=>'Thành viên', 'url'=>array('/Members'),'visible'=>!Yii::app()->user->isGuest),
